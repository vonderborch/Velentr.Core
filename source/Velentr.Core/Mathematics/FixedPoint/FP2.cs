...
public struct FP2 : IFixedPoint<FP2>, IBaseFixedPoint<long>
{
    ...
    {
        return (FP2)CreateFromDouble(double.Parse(s, provider));
    }
    ...
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, out FP2 result)
    {
        ...
        {
            result = (FP2)CreateFromDouble(value);
            return true;
        }
    ...
    {
        return (FP2)CreateFromDouble(double.Parse(s, style, provider));
    }
    ...
    public static bool TryConvertFromChecked<TOther>(TOther value, out FP2 result) where TOther : INumberBase<TOther>
    {
        ...
        if (typeof(TOther) == typeof(double))
        {
            ...
            result = (FP2)CreateFromDouble(doubleValue);
            return true;
        }
        ...
        if (typeof(TOther) == typeof(float))
        {
            ...
            result = (FP2)CreateFromFloat(floatValue);
            return true;
        }
        ...
        if (typeof(TOther) == typeof(decimal))
        {
            ...
            result = (FP2)CreateFromDouble((double)decimalValue);
            return true;
        }
    ...
    {
        return (FP2)CreateFromDouble((double)value);
    }
    ...
    {
        return (FP2)CreateFromDouble(value);
    }
    ...
    {
        return (FP2)CreateFromFloat(value);
    }
