...
namespace Velentr.Core.Helpers.Math.FixedPointMath.Precision4
{
    /// <summary>
    ...
    public struct FPL4
    {
        ...
        ///     The fourth one fpl.
        /// </summary>
        public static FPL4 OneFPL4 = CreateFromLong(1);

        /// <summary>
        ///     The maximum value.
        /// </summary>
        public static FPL4 MaxValue = CreateFromLong(long.MaxValue, false);

        /// <summary>
        ///     The minimum value.
        /// </summary>
        public static FPL4 MinValue = CreateFromLong(long.MinValue, false);
        ...
        public static FPL4 CreateFromDouble(double rawValue)
        {
            ...
            {
                result.RawValue = (int) System.Math.Round(rawValue * OneLong);
            }
            else if (rawValue <= long.MaxValue << Shift && rawValue >= long.MinValue << Shift)
            {
                result.RawValue = (long) System.Math.Round(rawValue * OneLong);
            }
            else
            {
        ...
        {
            var f = CreateFromLong(preDecimal);
            if (postDecimal >= 0)
            {
                f.RawValue += (CreateFromDouble(postDecimal) / 1000).RawValue;
            }
        ...
        public int ToInt()
        {
            return (int) (this.RawValue >> Shift);
        }
        ...
        {
            return (double) this.RawValue / OneLong;
        }
        ...
        {
            return (float) this.RawValue / OneLong;
        }
        ...
        ///     The inverse.
        /// </value>
        public FPL4 Inverse => CreateFromLong(-this.RawValue, false);
        ...
        {
            return source.RawValue / (float) OneLong;
        }
        ...
        {
            return source.RawValue / (double) OneLong;
        }
        ...
        {
            return CreateFromDouble(source);
        }
        ...
        public static FPL4 operator <<(FPL4 left, int right)
        {
            return CreateFromLong(left.RawValue << right, false);
        }
        ...
        {
            return obj is FPL4 ? ((FPL4) obj).RawValue == this.RawValue : false;
        }
        ...
        {
            return $"{System.Math.Round(ToDouble(), Precision)}";
        }
    }
}
