...
namespace Velentr.Core.Shapes
{
    ...
    public struct CircleD
    {
        ...
        ///     (Immutable) the zero.
        /// </summary>
        public static readonly CircleD Zero = new(0, 0, 0);

        /// <summary>
        ///     (Immutable) the one.
        /// </summary>
        public static readonly CircleD One = new(1, 1, 1);

        /// <summary>
        ///     (Immutable) the maximum value.
        /// </summary>
        public static readonly CircleD MaxValue = new(double.MaxValue, double.MaxValue, double.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum value.
        /// </summary>
        public static readonly CircleD MinValue = new(double.MinValue, double.MinValue, double.MinValue);
        ...
        ///     The result of the operation.
        /// </returns>
        public static implicit operator CircleD(PointF point)
        {
            return new CircleD((Point) point, 1);
        }
