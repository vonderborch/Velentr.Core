...
/// <summary>
/// Represents the Megabyte unit of measurement.
/// </summary>
public class MegaByte : Singleton<MegaByte>, IComputerBit
{
    /// <summary>
    /// Gets the name of the unit.
    /// </summary>
    public string Name => "MegaByte";
    ...
    /// </summary>
    public string UnitName => "Megabyte";
