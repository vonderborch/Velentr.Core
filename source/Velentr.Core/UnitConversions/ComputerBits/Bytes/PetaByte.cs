...
/// <summary>
/// Represents the Petabyte unit of measurement.
/// </summary>
public class PetaByte : Singleton<PetaByte>, IComputerBit
{
    /// <summary>
    /// Gets the name of the unit.
    /// </summary>
    public string Name => "PetaByte";
    ...
    /// </summary>
    public string UnitName => "Petabyte";
