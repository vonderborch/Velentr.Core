...
public static class ArchiveHelpers
{
    ...
    /// <exception cref="IOException">Thrown if the archive file already exists and deleteExistingFile is false, or if the destination directory already exists and deleteExistingDestinationDirectory is false.</exception>
    public static void ArchiveDirectory(string sourceDirectory, string archivePath, CompressionLevel compressionLevel = CompressionLevel.Optimal, bool includeBaseDirectory = false, bool deleteExistingFile = false, bool deleteSourceDirectory = false)
    {
    ...
    /// <summary>
    /// Extracts the contents of a zip archive to the specified destination directory, with an option to delete the existing directory if it exists.
    /// </summary>
    ...
    /// <param name="deleteExistingDestinationDirectory">Whether to delete the existing destination directory if it exists. Default is false.</param>
    /// <exception cref="IOException">Thrown if the destination directory already exists and deleteExistingDestinationDirectory is false.</exception>
    public static void ExtractDirectory(string archivePath, string destinationDirectory, bool deleteExistingDestinationDirectory = false)
    {
