...
public static class FileHelpers
{
    ...
    public static void SafeCopyFile(string source, string destination, int maxRetries = 10, int baseDelayMs = 50, int maxDelayMs = 500, double delayMultiplier = 2)
    {
    ...
    public static void DeleteFileIfExists(string filePath, int maxRetries = 10, int baseDelayMs = 50, int maxDelayMs = 500, double delayMultiplier = 2)
    {
