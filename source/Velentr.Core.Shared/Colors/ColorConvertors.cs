...
public static class ColorConvertors
{
    ...
    {
        (double red, double green, double blue) color = HexHelpers.ConvertHexToRgb(hex);
    ...
    {
        (double red, double green, double blue) color = HslHelpers.ConvertHslToRgb(hue, saturation, lightness);
        return new Color((float)color.red, (float)color.green, (float)color.blue, alpha);
    }
    ...
    {
        (double red, double green, double blue) color = HsvHelpers.ConvertHsvToRgb(hue, saturation, value);
        return new Color((float)color.red, (float)color.green, (float)color.blue, alpha);
    }
