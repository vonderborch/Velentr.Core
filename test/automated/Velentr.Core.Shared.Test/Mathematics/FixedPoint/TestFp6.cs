...
public class TestFp6
{
    ...
    {
        var value = new FP6 { RawValue = 12345 };
    ...
    {
        var value = FP6.CreateFromDouble(3.005723);
    ...
    {
        var value = FP6.CreateFromDouble(7d / 3);
    ...
    {
        var value = FP6.CreateFromFloat(3.005723f);
        Assert.That(value.RawValue, Is.EqualTo(3151729));
    }
    ...
    {
        var value1 = new FP6 { RawValue = 12345 };
        var value2 = new FP6 { RawValue = 67890 };
    ...
    {
        var value1 = new FP6 { RawValue = 67890 };
        var value2 = new FP6 { RawValue = 12345 };
        var result = value1 - value2;
    ...
    {
        var value1 = new FP6 { RawValue = 12345 };
        var value2 = new FP6 { RawValue = 2 << FP6.Shift };
        var result = value1 * value2;
    ...
    {
        var value1 = new FP6 { RawValue = 24690 };
        var value2 = new FP6 { RawValue = 2 << FP6.Shift };
        var result = value1 / value2;
    ...
    {
        var value = FP6.Parse("3.005723", CultureInfo.InvariantCulture);
        Assert.That(value.RawValue, Is.EqualTo(3151729));
    }
    ...
    {
        var success = FP6.TryParse("3.005723", CultureInfo.InvariantCulture, out var value);
