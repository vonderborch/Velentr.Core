...
public class TestFp4
{
    ...
    {
        var value = new FP4 { RawValue = 12345 };
    ...
    {
        var value = FP4.CreateFromDouble(3.0057);
    ...
    {
        var value = FP4.CreateFromDouble(7d / 3);
    ...
    {
        var value = FP4.CreateFromFloat(3.0057f);
        Assert.That(value.RawValue, Is.EqualTo(49245));
    }
    ...
    {
        var value1 = new FP4 { RawValue = 12345 };
        var value2 = new FP4 { RawValue = 67890 };
    ...
    {
        var value1 = new FP4 { RawValue = 67890 };
        var value2 = new FP4 { RawValue = 12345 };
        var result = value1 - value2;
    ...
    {
        var value1 = new FP4 { RawValue = 12345 };
        var value2 = new FP4 { RawValue = 2 << FP4.Shift };
        var result = value1 * value2;
    ...
    {
        var value1 = new FP4 { RawValue = 24690 };
        var value2 = new FP4 { RawValue = 2 << FP4.Shift };
        var result = value1 / value2;
    ...
    {
        var value = FP4.Parse("3.0057", CultureInfo.InvariantCulture);
        Assert.That(value.RawValue, Is.EqualTo(49245));
    }
    ...
    {
        var success = FP4.TryParse("3.0057", CultureInfo.InvariantCulture, out var value);
