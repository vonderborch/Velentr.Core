...
public class TestColorThresholds
{
    ...
    public void TestRgbMeetsMinRgbThreshold_AllValuesMeetThreshold()
    {
        ...
        bool result = ColorThresholds.RgbMeetsMinRgbThreshold(red, green, blue, alpha, thresholdRed, thresholdGreen, thresholdBlue, thresholdAlpha);
    ...
    public void TestHexMeetsMinRgbThreshold_AllValuesMeetThreshold()
    {
        ...
        double alpha = 0.5;
        double thresholdRed = 0.4, thresholdGreen = 0.4, thresholdBlue = 0.4, thresholdAlpha = 0.4;
        bool result = ColorThresholds.HexMeetsMinRgbThreshold(hex, alpha, thresholdRed, thresholdGreen, thresholdBlue, thresholdAlpha);
        Assert.That(result, Is.True);
    }
    ...
    public void TestRgbMeetsMinHslThreshold_AllValuesMeetThreshold()
    {
        ...
        bool result = ColorThresholds.RgbMeetsMinHslThreshold(red, green, blue, alpha, thresholdHue, thresholdSaturation, thresholdLightness, thresholdAlpha);
        Assert.That(result, Is.True);
    }
    ...
    public void TestRgbMeetsMinHsvThreshold_AllValuesMeetThreshold()
    {
        ...
        bool result = ColorThresholds.RgbMeetsMinHsvThreshold(red, green, blue, alpha, thresholdHue, thresholdSaturation, thresholdValue, thresholdAlpha);
        Assert.That(result, Is.True);
    }
