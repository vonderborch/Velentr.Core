...
namespace Velentr.Core.Test.Json
{
    ...
    public class TestExpressionSerializer
    {
        ...
        public void TestDeserializeExpression()
        {
            ...
            // Act
            var deserializedExpression = ExpressionSerializer<Func<int, int>>.DeserializeExpression(serializedExpression);
        ...
        public void TestInvalidDeserialization()
        {
            ...
            Assert.That(() =>
            {
                ExpressionSerializer<Func<int, int>>.DeserializeExpression(invalidSerializedExpression);
            }, Throws.Exception);
        }
    }
}
